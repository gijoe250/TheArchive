        ...
        <div class="card horizontally-aligned" style="width: 25rem;">
            <div class="card" id="card" style="max-width: 30rem;">
                <div class="card bg-dark text-white">
                    ...
                    <br>
                    <div class="card-body">
                        <div align="center"><font size="4">{{ message }}</font></div><br>
                        <form>
                            <div class="row">
                                <div class="col">
                            ...
                            <br>
                            <br>
                            <font size="4">Don't have an account? <router-link to="/register" class="">Sign up</router-link></font> 	
                        </form>
                    </div>
            </div>
            </div>
    ...
    methods: {
        login: function(){
            if ( this.username == '' || this.password == '' ){
                ...
                axios
                .post('http://localhost:8081/api/post/', loginInfo)
                .then(response => {
